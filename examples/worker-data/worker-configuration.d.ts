/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.local.jsonc --strict-vars=false` (hash: 1bb64feef6553afb00fcfeac27890ef5)
// Runtime types generated with workerd@1.20260907.1 2026-09-08 nodejs_compat
interface __BaseEnv_Env {
	BUSINESS_DB: D1Database;
	APP_ENV: string;
	TARGET_ID: string;
	TRIGGER_QUEUE_NAME: string;
	BUILD_ID: string;
	PLATFORM_REGISTRATION_URL: string;
	REGISTRATION_TOKEN: string;
	TEST_CONTROL_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "TARGET_ID" | "TRIGGER_QUEUE_NAME" | "BUILD_ID" | "PLATFORM_REGISTRATION_URL" | "REGISTRATION_TOKEN" | "TEST_CONTROL_SECRET">> {}
}
