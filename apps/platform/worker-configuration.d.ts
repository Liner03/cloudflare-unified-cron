/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.local.jsonc` (hash: 58959a6702e1528d0227395150cd7ac0)
...
interface __BaseEnv_Env {
	...
	PLATFORM_INSTANCE_ID: "00000000-0000-4000-8000-000000000001";
	BUILD_VERSION: "local";
	CRON_DATA: Service /* entrypoint CronEntrypoint from worker-data-local */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "AUTH_MODE" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "PUBLIC_ORIGIN" | "PLATFORM_INSTANCE_ID" | "BUILD_VERSION">> {}
}
